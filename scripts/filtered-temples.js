...
const temples = [
  ...
  },
  {
    ...
    area: 22148,
    imageUrl: "images/kyiv-ukraine-temple"
  }
];
...
nonutahLink.addEventListener("click", () => let nonutah = temples.filter(temple.location.includes("utah"));
createTempleCards(nonutah));